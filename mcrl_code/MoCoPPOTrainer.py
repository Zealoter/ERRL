...
from MoCoPPOPolicy import MoCoPPOTorchPolicy
...
DEFAULT_CONFIG = with_common_config({
    # 自己加入
    "history_model_save_upper"   : 20,
    "history_model_save_interval": 5,
    "elo_compare_time"           : 5,
...
MoCoPPOTrainer = build_trainer(
    name="MoCoPPO",
    default_config=DEFAULT_CONFIG,
    validate_config=validate_config,
    default_policy=MoCoPPOTorchPolicy,
